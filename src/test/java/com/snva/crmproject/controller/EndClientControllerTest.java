...
class EndClientControllerTest {
    ...
    void testGetAllEndClients() throws Exception {
        // Arrange
        when(endClientService.getAllEndClients()).thenReturn(new ArrayList<>());
    ...
    void testGetEndClientById() throws Exception {
        ...
        when(endClientService.getEndClientById(Mockito.<Long>any())).thenReturn(ofResult);
    ...
    void testGetEndClientById2() throws Exception {
        ...
        when(endClientService.getEndClientById(Mockito.<Long>any())).thenReturn(emptyResult);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/v1/end-clients/{id}", 1L);
    ...
    void testDeleteEndClient() throws Exception {
        // Arrange
        doNothing().when(endClientService).deleteEndClient(Mockito.<Long>any());
    ...
    void testUpdateEndClient() throws Exception {
        ...
        endClient.setState("MD");
        Optional<EndClient> ofResult = Optional.of(endClient);
        when(endClientService.updateEndClient(Mockito.<Long>any(), Mockito.<EndClient>any())).thenReturn(ofResult);
    ...
    void testUpdateEndClient2() throws Exception {
        // Arrange
        Optional<EndClient> emptyResult = Optional.empty();
        when(endClientService.updateEndClient(Mockito.<Long>any(), Mockito.<EndClient>any())).thenReturn(emptyResult);
